let mutations = {
    ...
    updateLatestBlock: function (state, latestBlock) {
        Object.assign(state.chain, latestBlock)
    },
    updateLatestStats: function (state, latestStats) {
        Object.assign(state.chain, latestStats)
    }
