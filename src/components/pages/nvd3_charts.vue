<template>
    <div>
        <div class="row">
            <div class="col-lg-12">
                <card title=" <i class='ti-bar-chart'></i> Stacked/Grouped Multi-Bar Chart">
                    <div id="chart1">
                        <svg></svg>
                    </div>
                </card>
        ...
        <div class="row">
            <div class="col-lg-6">
                <card title=" <i class='ti-bar-chart-alt'></i> Line Plus Bar Chart">
            ...
            <div class="col-lg-6">
                <card title=" <i class='ti-bar-chart'></i> Horizontal Multi-Bar Chart">
        ...
        <div class="row">
            <div class="col-lg-12">
                <card title="<i class='ti-bar-chart-alt'></i> Cumulative Line Chart">
        ...
        <div class="row">
            <div class="col-lg-12">
                <card title="<i class='ti-bar-chart-alt'></i> Scatter / Bubble Chart" class="bg-card">
        ...
        <div class="row">
            <div class="col-lg-12">
                <card title="<i class='ti-bar-chart-alt'></i> Area Chart">
        ...
        <div class="row">
            <div class="col-lg-12">
                <card title="<i class='ti-pie-chart'></i> Sunburst Chart">
