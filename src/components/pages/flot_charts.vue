<template>
    <div>
        <div class="row">
            <div class="col-md-6">
                <card title="<i class='ti-bar-chart-alt'></i> Spline Line Chart">
                    <div id="basicFlotLegend1" class="flotLegend"></div>
                    <div id="basicflot" class="flotChart"></div>
                </card>
            </div>
            <div class="col-md-6">
                <card title="<i class='ti-bar-chart-alt'></i> Line Chart">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <card title="<i class='ti-bar-chart'></i> Bar Charts" class="body-bg">
            ...
            <div class="col-lg-6">
                <!-- Stack charts strats here-->
                <card title="<i class='ti-bar-chart'></i> Stacked Bar Charts">
        ...
        <div class="row">
            <div class="col-lg-4">
                <!-- Stack charts strats here-->
                <card title=" <i class='ti-pie-chart'></i> Donut">
                    <div id="donut" class="flotChart2"></div>
                </card>
            </div>
            <div class="col-lg-8">
                <!-- Stack charts strats here-->
                <card title="<i class='ti-pie-chart'></i> Pie Charts">
                    <div class="row">
                        <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <card title='<i class="ti-bar-chart"></i> Real Time Charts'>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <card title="<i class='ti-bar-chart'></i> Area Chart">
                    <div id="area-chart" class="flotChart3"></div>
                </card>
            </div>
            <div class="col-lg-6">
                <!-- Real time charts strats here-->
                <card title="<i class='ti-bar-chart'></i> Spline Area Chart">
